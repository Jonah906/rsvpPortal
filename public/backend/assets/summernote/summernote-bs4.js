...
var Context_Context = /*#__PURE__*/function () {
  ...
  _createClass(Context, [{
    ...
    key: "createInvokeHandlerAndUpdate",
    value: function createInvokeHandlerAndUpdate(namespace, value) {
      var _this3 = this;
...
var Style_Style = /*#__PURE__*/function () {
  ...
  Style_createClass(Style, [{
    ...
    value: function current(rng) {
      ...
      var styleInfo = this.fromNode($cont); // document.queryCommand for toggle state
      // [workaround] prevent Firefox nsresult: "0x80004005 (NS_ERROR_FAILURE)"

      try {
        styleInfo = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(styleInfo, {
          'font-bold': document.queryCommand('bold') ? 'bold' : 'normal',
          'font-italic': document.queryCommand('italic') ? 'italic' : 'normal',
          'font-underline': document.queryCommand('underline') ? 'underline' : 'normal',
          'font-subscript': document.queryCommand('subscript') ? 'subscript' : 'normal',
          'font-superscript': document.queryCommand('superscript') ? 'superscript' : 'normal',
          'font-strikethrough': document.queryCommand('strikethrough') ? 'strikethrough' : 'normal',
...
var Buttons_Buttons = /*#__PURE__*/function () {
  ...
  Buttons_createClass(Buttons, [{
    ...
    value: function addToolbarButtons() {
      ...
      this.context.memo('button.bold', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdate('editor.bold')
        }).render();
      });
      this.context.memo('button.italic', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdate('editor.italic')
        }).render();
      });
      this.context.memo('button.underline', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdate('editor.underline')
        }).render();
      });
      ...
      this.context.memo('button.strikethrough', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdate('editor.strikethrough')
        }).render();
      });
      this.context.memo('button.superscript', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdate('editor.superscript')
        }).render();
      });
      this.context.memo('button.subscript', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdate('editor.subscript')
        }).render();
      });
      this.context.memo('button.fontname', function () {
        ...
        return _this2.ui.buttonGroup([_this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdate('editor.fontName')
        })]).render();
      });
      this.context.memo('button.fontsize', function () {
        return _this2.ui.buttonGroup([_this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdate('editor.fontSize')
        })]).render();
      });
      this.context.memo('button.fontsizeunit', function () {
        return _this2.ui.buttonGroup([_this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdate('editor.fontSizeUnit')
        })]).render();
      });
    ...
    key: "updateBtns",
    value: function updateBtns($container, infos) {
      var _this7 = this;
